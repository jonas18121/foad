 ...
 */
final class Version20210115121149 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C5B6BE94D740ACAC ON classe_decole (numero_classe)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C5B6BE94D740ACAC ON classe_decole');
    }
}
